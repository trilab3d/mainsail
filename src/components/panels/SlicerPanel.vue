    ...
    <v-card outlined>
        ...
        <v-card-text>
            <div class="panel">
                ...
                <img
                    class="panel-image v-card__title"
                    :src="$t(`App.Trilab.Panels.trilabSlicers.${target}.imgsrc`)"
                    alt="" />
                <v-row>
                    <v-col cols="12" md="8">
                        <p
                ...
                <v-btn
                    class="panel-download-btn mt-3 mb-3"
                    :href="getHrefLink"
                    @click="downloadSP()"
                    color="primary"
                    block>
                    {{ $t('App.Trilab.SlicerPanel.downloadSlicer') }}
                </v-btn>
                <v-btn
                    v-if="slicerProfilesDownloadUrl != ''"
                    block
                    color="#ED6B21"
                    class="panel-download-btn mt-3 mb-3"
