<template>
    <panel
        ...
        <template #buttons>
            <v-menu v-if="showButtons && AdvancedFeatures" left offset-y :close-on-content-click="false" class="pa-0">
        ...
        <!-- Z-OFFSET CONTROL -->
        <v-divider v-if="AdvancedFeatures && showZOffset" />
        <v-container v-if="AdvancedFeatures && showZOffset">
            <zoffset-control />
        </v-container>
        <!-- SPEED FACTOR -->
