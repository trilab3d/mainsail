    ...
    <v-dialog
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <div v-if="step == 1">
                    Check endstop A functionality. Press down endstop multiple times until you see "Registered" message
                    <img
                        src="/img/diagnostics/endstopsA.gif"
                ...
                <div v-if="step == 2">
                    Check endstop B functionality. Press down endstop multiple times until you see "Registered" message
                    <img
                        src="/img/diagnostics/endstopsB.gif"
                        style="max-width: 300px" />
                    <p
                        class="mb-4 mt-4"
                        style="text-align: center; font-weight: bold; font-size: 125%">
                ...
                <div v-if="step == 3">
                    Check endstop C functionality. Press down endstop multiple times. If it is registered, dialog will
                    close
                    <img
                        src="/img/diagnostics/endstopsC.gif"
                        style="max-width: 300px" />
                    <p
                        class="mb-4 mt-4"
                        style="text-align: center; font-weight: bold; font-size: 125%">
